 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const u1=5*60,h1=kf("authIdTokenMaxAge")||u1;let vd=null;const d1=t=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>h1)return;const r=n==null?void 0:n.token;vd!==r&&(vd=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function f1(t=xf()){const e=el(t,"auth");if(e.isInitialized())return e.getImmediate();const n=Fb(t,{popupRedirectResolver:o1,persistence:[yC,iC,Nm]}),s=kf("authTokenSyncURL");if(s){const i=d1(s);Zb(n,i,()=>i(n.currentUser)),Jb(n,o=>i(o))}const r=Af("auth");return r&&$b(n,`http://${r}`),n}l1("Browser");async function p1(t){const e=Kl(t,"/restaurants/"),n=Zg(e),s=await nm(n);let r=[];return s.forEach(i=>{r.push(i)}),r}const es=(t,e)=>{const n=t.__vccOpts||t;for(const[s,r]of e)n[s]=r;return n},g1={props:["db"],data(){return{isOptionsExpanded:!1,selectedOption:"select Restaurant",options:[]}},methods:{setOption(t){this.selectedOption=t,this.isOptionsExpanded=!1,this.$emit("selected",this.selectedOption)},async openMenu(){this.isOptionsExpanded=!this.isOptionsExpanded;const t=await p1(this.db);this.options=[],t.forEach(e=>{this.options.push(e.id)})}}},m1={class:"relative mb-2 p-1 w-full rounded bg-medium border border-bright font-bold"},y1=N("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M19 9l-7 7-7-7"},null,-1),v1=[y1],w1={class:"z-50 absolute translate-y-2 left-0 right-0 mb-4 bg-medium divide-y divide-bright rounded-lg shadow-lg overflow-hidden border-2 border-bright"},_1=["onMousedown"];function E1(t,e,n,s,r,i){return ve(),ke("div",m1,[N("button",{class:"flex w-full items-center justify-between",onClick:e[0]||(e[0]=o=>i.openMenu()),onBlur:e[1]||(e[1]=o=>r.isOptionsExpanded=!1)},[N("span",null,nt(r.selectedOption),1),(ve(),ke("svg",{fill:"none",viewBox:"0 0 24 24",stroke:"currentColor",class:Ds(["h-4 w-4 transform transition-transform duration-200 ease-in-out",r.isOptionsExpanded?"rotate-180":"rotate-0"])},v1,2))],32),ge(So,null,{default:_o(()=>[st(N("ul",w1,[(ve(!0),ke(rt,null,Wc(r.options,(o,a)=>(ve(),ke("li",{key:a,class:"p-1 transition-colors duration-300 hover:bg-bright",onMousedown:ww(c=>i.setOption(o),["prevent"])},nt(o),41,_1))),128))],512),[[Pr,r.isOptionsExpanded]])]),_:1})])}const Fm=es(g1,[["render",E1]]),I1={components:{},props:["text"],data(){return{points:null}},methods:{setPoints(t){console.log(t),this.points=t},getPoints(){return this.points}}},T1={class:"flex"},b1=N("div",{class:"bg-points-1 bg-points-2 bg-points-3 bg-points-4 bg-points-5 bg-points-6 bg-points-7 bg-points-8 bg-points-9 bg-points-10"},null,-1),C1={class:"text-bright font-bold col-span-3 w-[20%] min-w-[4rem]"},S1={class:"w-[80%] max-w-sm grid grid-cols-10"},A1=["onClick"];function k1(t,e,n,s,r,i){return ve(),ke("div",T1,[b1,N("div",C1,nt(n.text),1),N("div",S1,[(ve(),ke(rt,null,Wc(10,o=>N("div",{class:Ds(["rounded-xl bg-bright w-5 h-5 m-1",[o<=r.points?`bg-points-${r.points}`:""]]),onClick:a=>this.setPoints(o)},null,10,A1)),64))])])}const R1=es(I1,[["render",k1]]),N1={components:{DropDown:Fm,PointSelect:R1},props:["db","user"],data(){return{failed_entry:!1,active:!1,taste_rating:void 0,taste_notes:"",service_rating:void 0,service_notes:"",price_rating:void 0,price_notes:"",environment_rating:void 0,environment_notes:"",general_notes:"",showForm:!1,restaurant_name:void 0}},methods:{resetReviewForm(t){this.restaurant_name=t,this.taste_rating=void 0,this.taste_notes="",this.service_rating=void 0,this.service_notes="",this.price_rating=void 0,this.price_notes="",this.environment_rating=void 0,this.environment_notes="",this.general_notes="",this.showForm=!1,this.showForm=!0},isValidInput(){var t,e,n,s,r,i,o,a;return!(!((t=this.$refs.TastePoints)!=null&&t.getPoints())||isNaN((e=this.$refs.TastePoints)==null?void 0:e.getPoints())||!((n=this.$refs.ServicePoints)!=null&&n.getPoints())||isNaN((s=this.$refs.ServicePoints)==null?void 0:s.getPoints())||!((r=this.$refs.PricePoints)!=null&&r.getPoints())||isNaN((i=this.$refs.PricePoints)==null?void 0:i.getPoints())||!((o=this.$refs.EnvPoints)!=null&&o.getPoints())||isNaN((a=this.$refs.EnvPoints)==null?void 0:a.getPoints()))},isNumber(t){return isNaN(t)?fasle:!0},async addEntry(){if(console.log(this.isValidInput()),!this.isValidInput()){this.failed_entry=!0;return}const t={Taste:{rating:this.$refs.TastePoints.points,notes:this.taste_notes},Service:{rating:this.$refs.ServicePoints.points,notes:this.service_notes},Price:{rating:this.$refs.PricePoints.points,notes:this.price_notes},Environment:{rating:this.$refs.EnvPoints.points,notes:this.environment_notes},GeneralNotes:this.general_notes,User:this.user.email};try{const e=await ab(Kl(this.db,`/restaurants/${this.restaurant_name}/Reviews`),t);this.showForm=!1}catch(e){console.error("Error adding: ",e)}}}},D1={class:"p-2 border-2 border-bright rounded-xl bg-widged-bg"},x1={class:"mt-2 mx-3"},O1={key:0,class:"mx-1"},P1={class:"flex w-full mt-2"},M1=N("div",{class:"w-[20%] min-w-[4rem] text-bright font-bold"}," Taste ",-1),L1={class:"flex w-full mt-2"},F1=N("div",{class:"w-[20%] min-w-[4rem] text-bright font-bold"}," Service ",-1),U1={class:"flex w-full mt-2"},$1=N("div",{class:"w-[20%] min-w-[4rem] text-bright font-bold"}," Price ",-1),V1={class:"flex w-full mt-2"},B1=N("div",{class:"w-[20%] min-w-[4rem] text-bright font-bold"}," Env ",-1),j1={class:"mb-2 text-bright font-bold"},q1=N("div",{class:"mb-1"}," General Notes: ",-1),H1={key:0};function K1(t,e,n,s,r,i){const o=Fn("DropDown"),a=Fn("PointSelect");return ve(),ke("div",D1,[N("div",{class:"p-1 text-xl rounded-lg text-dark text-center font-bold bg-bright hover:bg-slightly-brighter",onClick:e[0]||(e[0]=c=>r.active=!r.active)}," add new Review "),st(N("div",x1,[ge(o,{db:n.db,onSelected:e[1]||(e[1]=c=>i.resetReviewForm(c))},null,8,["db"]),ge(So,{"enter-active-class":"duration-300","enter-from-class":"transform opacity-0 scale-0","enter-to-class":"scale-100 opacity-100","leave-active-class":"duration-300","leave-from-class":"scale-100 opacity-100","leave-to-class":"transform opacity-0 scale-0"},{default:_o(()=>[r.showForm?(ve(),ke("div",O1,[ge(a,{text:"Taste",ref:"TastePoints"},null,512),ge(a,{text:"Service",ref:"ServicePoints"},null,512),ge(a,{text:"Price",ref:"PricePoints"},null,512),ge(a,{text:"Env",ref:"EnvPoints"},null,512),N("div",P1,[M1,st(N("input",{class:"w-[80%] rounded bg-bright px-3 py-1 text-dark","onUpdate:modelValue":e[2]||(e[2]=c=>r.taste_notes=c)},null,512),[[Bt,r.taste_notes]])]),N("div",L1,[F1,st(N("input",{class:"w-[80%] rounded bg-bright px-3 py-1 text-dark","onUpdate:modelValue":e[3]||(e[3]=c=>r.service_notes=c)},null,512),[[Bt,r.service_notes]])]),N("div",U1,[$1,st(N("input",{class:"w-[80%] rounded bg-bright px-3 py-1 text-dark","onUpdate:modelValue":e[4]||(e[4]=c=>r.price_notes=c)},null,512),[[Bt,r.price_notes]])]),N("div",V1,[B1,st(N("input",{class:"w-[80%] rounded bg-bright px-3 py-1 text-dark","onUpdate:modelValue":e[5]||(e[5]=c=>r.environment_notes=c)},null,512),[[Bt,r.environment_notes]])]),N("div",j1,[q1,st(N("input",{class:"w-full text-dark rounded bg-bright px-3 py-1","onUpdate:modelValue":e[6]||(e[6]=c=>r.general_notes=c)},null,512),[[Bt,r.general_notes]])]),N("button",{class:Ds(["p-1 ml-[35%] w-[calc(30%)] rounded-lg font-bold truncate",["bg-button-bg hover:bg-button-hover"]]),onClick:e[7]||(e[7]=c=>i.addEntry())},"add Entry"),r.failed_entry?(ve(),ke("div",H1," please give Points for everything ")):jt("",!0)])):jt("",!0)]),_:1})],512),[[Pr,r.active]])])}const z1=es(N1,[["render",K1]]),W1={components:{DropDown:Fm},props:["db"],data(){return{active:!1,restaurant_name:void 0,reviews:[]}},created(){},methods:{async getReviews(t){this.reviews=[];const e=Kl(this.db,`/restaurants/${t}/Reviews`),n=Zg(e);(await nm(n)).forEach(r=>{this.reviews.push(r)})}}},G1={class:"p-2 border-2 border-bright rounded-xl bg-widged-bg"},Q1={class:"mt-2"},X1={class:"mx-10 mb-5"},Y1={class:"mb-2"},J1={class:"p-1 mb-5 text-xl rounded-xl text-dark text-center font-bold bg-bright"},Z1={class:""},eS={class:"flex w-full m-2"},tS=N("div",{class:"w-1/5 text-bright font-bold"}," Taste ",-1),nS={class:"w-1/12 mx-2 rounded bg-bright text-center text-dark"},sS={class:"w-[50%] rounded bg-bright px-3 py-1 text-dark"},rS={class:"flex w-full m-2"},iS=N("div",{class:"w-1/5 text-bright font-bold"}," Service ",-1),oS={class:"w-1/12 mx-2 rounded bg-bright text-center text-dark"},aS={class:"w-[50%] rounded bg-bright px-3 py-1 text-dark"},cS={class:"flex w-full m-2"},lS=N("div",{class:"w-1/5 text-bright font-bold"}," Price ",-1),uS={class:"w-1/12 mx-2 rounded bg-bright text-center text-dark"},hS={class:"w-[50%] rounded bg-bright px-3 py-1 text-dark"},dS={class:"flex w-full m-2"},fS=N("div",{class:"w-1/5 text-bright font-bold"}," Environment ",-1),pS={class:"w-1/12 mx-2 rounded bg-bright text-center text-dark"},gS={class:"w-[50%] rounded bg-bright px-3 py-1 text-dark"},mS={class:"mx-2 mb-2 text-bright font-bold"},yS=N("div",{class:"mb-1"}," General Notes: ",-1),vS={class:"w-full rounded bg-bright px-3 py-1 text-dark"};function wS(t,e,n,s,r,i){const o=Fn("DropDown");return ve(),ke("div",G1,[N("div",{class:"p-1 text-xl rounded-lg text-dark text-center font-bold bg-bright hover:bg-slightly-brighter",onClick:e[0]||(e[0]=a=>r.active=!r.active)}," Reviews "),st(N("div",Q1,[ge(o,{class:"mb-10",db:n.db,onSelected:e[1]||(e[1]=a=>i.getReviews(a))},null,8,["db"]),(ve(!0),ke(rt,null,Wc(this.reviews,a=>(ve(),ke("div",X1,[N("div",Y1,[N("div",J1," Review created by "+nt(a.data().User),1),N("div",Z1,[N("div",eS,[tS,N("div",nS,nt(a.data().Taste.rating),1),N("div",sS,nt(a.data().Taste.notes),1)]),N("div",rS,[iS,N("div",oS,nt(a.data().Service.rating),1),N("div",aS,nt(a.data().Service.notes),1)]),N("div",cS,[lS,N("div",uS,nt(a.data().Price.rating),1),N("div",hS,nt(a.data().Price.notes),1)]),N("div",dS,[fS,N("div",pS,nt(a.data().Environment.rating),1),N("div",gS,nt(a.data().Environment.notes),1)])]),N("div",mS,[yS,N("div",vS,nt(a.data().GeneralNotes),1)])])]))),256))],512),[[Pr,r.active]])])}const _S=es(W1,[["render",wS]]),ES={props:["loggedIn","user"],data(){return{email:"",password:"",active:!1}},created(){},methods:{logIn(){this.$emit("login",[this.email,this.password])},logOut(){this.$emit("logout")}}},IS={class:"p-2 border-2 border-bright rounded-xl bg-widged-bg"},TS={class:"mt-2"},bS={key:0,class:"ml-[5%] mb-2 p-1 rounded bg-medium w-[90%] font-bold truncate"},CS={key:1};function SS(t,e,n,s,r,i){return ve(),ke("div",IS,[N("div",{class:"p-1 text-xl rounded-lg text-dark text-center font-bold bg-bright hover:bg-slightly-brighter",onClick:e[0]||(e[0]=o=>r.active=!r.active)}," Account "),st(N("div",TS,[ge(hw,{"enter-active-class":"duration-300","enter-from-class":"transform opacity-0 scale-0","enter-to-class":"scale-100 opacity-100","leave-active-class":"duration-300","leave-from-class":"scale-100 opacity-100","leave-to-class":"transform opacity-0 scale-0"},{default:_o(()=>[n.loggedIn&&n.user?(ve(),ke("div",bS,' Logged in as: "'+nt(n.user.email)+'" ',1)):jt("",!0),n.loggedIn?jt("",!0):(ve(),ke("div",CS,[st(N("input",{class:"mb-2 ml-[5%] p-1 rounded bg-medium border border-bright w-[90%] font-bold",type:"email","onUpdate:modelValue":e[1]||(e[1]=o=>r.email=o),placeholder:"E-Mail"},null,512),[[Bt,r.email]]),st(N("input",{class:"mb-2 ml-[5%] p-1 rounded bg-medium border border-bright w-[90%]",type:"password","onUpdate:modelValue":e[2]||(e[2]=o=>r.password=o),placeholder:"Password"},null,512),[[Bt,r.password]])]))]),_:1}),n.loggedIn?jt("",!0):(ve(),ke("button",{key:0,class:"p-1 ml-[35%] w-[30%] rounded-lg bg-button-bg hover:bg-button-hover font-bold truncate",onClick:e[3]||(e[3]=o=>i.logIn())},"Log In")),n.loggedIn?(ve(),ke("button",{key:1,class:"p-1 ml-[35%] w-[30%] rounded-lg bg-button-bg hover:bg-button-hover font-bold truncate",onClick:e[4]||(e[4]=o=>i.logOut())},"Log Out")):jt("",!0)],512),[[Pr,r.active]])])}const AS=es(ES,[["render",SS]]),kS={props:["db"],data(){return{name:void 0,location:void 0,active:!1}},created(){},methods:{async addRestaurant(){const t={Name:this.name,Location:this.location};try{const e=await ob(Bg(this.db,"/restaurants/",this.name),t);console.log(e),this.showForm=!1}catch(e){console.error("Error adding: ",e)}}}},RS={class:"p-2 border-2 border-bright rounded-xl bg-widged-bg"};function NS(t,e,n,s,r,i){return ve(),ke("div",RS,[N("div",{class:"p-1 text-xl rounded-lg text-dark text-center font-bold bg-bright hover:bg-slightly-brighter",onClick:e[0]||(e[0]=o=>r.active=!r.active)}," add new Restaurant "),st(N("div",null,[st(N("input",{class:"my-2 ml-5 p-1 rounded bg-medium border border-bright w-[calc(100%-2.5rem)] font-bold truncate","onUpdate:modelValue":e[1]||(e[1]=o=>r.name=o),placeholder:"Name"},null,512),[[Bt,r.name]]),st(N("input",{class:"mb-2 ml-5 p-1 rounded bg-medium border border-bright w-[calc(100%-2.5rem)]","onUpdate:modelValue":e[2]||(e[2]=o=>r.location=o),placeholder:"Location"},null,512),[[Bt,r.location]]),N("button",{class:"p-1 ml-[35%] w-[30%] rounded-lg bg-button-bg hover:bg-button-hover font-bold truncate",onClick:e[3]||(e[3]=o=>i.addRestaurant())},"add")],512),[[Pr,r.active]])])}const DS=es(kS,[["render",NS]]),xS={components:{ReviewForm:z1,ReviewBrowser:_S,LoginWidged:AS,AddRestaurant:DS},data(){return{email:"",password:"",auth:"",user:"",loggedIn:!1,restRefs:"",db:void 0,app:void 0,entries:void 0}},created(){this.authenticate(),this.db=qT()},methods:{authenticate(){const t={apiKey:"AIzaSyALV08bfPkleXurrp4q-ZZqLB1buSChfhU",authDomain:"restlist-ab369.firebaseapp.com",projectId:"restlist-ab369",storageBucket:"restlist-ab369.appspot.com",messagingSenderId:"1032725124554",appId:"1:1032725124554:web:304b9b702ca638157aab33",measurementId:"G-7FGCH3NTKT"};this.app=Df(t),this.auth=f1(),eC(this.auth,e=>{e?(this.user=e,this.loggedIn=!0,e.uid):this.loggedIn=!1})},async logIn(t){await Yb(this.auth,t[0],t[1]).then(e=>{this.user=e.user}).catch(e=>{this.errorCode=e.code,this.errorMessage=e.message})},async logOut(){await tC(this.auth).then(()=>{}).catch(t=>{})}}},OS={class:"min-h-screen bg-base-bg pt-10 px-[2%]"},PS={class:"w-full grid items-start gap-5 lg:grid-cols-2"};function MS(t,e,n,s,r,i){const o=Fn("LoginWidged"),a=Fn("AddRestaurant"),c=Fn("ReviewForm"),l=Fn("ReviewBrowser");return ve(),ke("div",OS,[N("div",PS,[ge(o,{loggedIn:r.loggedIn,user:r.user,onLogin:e[0]||(e[0]=u=>i.logIn(u)),onLogout:e[1]||(e[1]=u=>i.logOut())},null,8,["loggedIn","user"]),r.loggedIn?(ve(),Ai(a,{key:0,db:r.db},null,8,["db"])):jt("",!0),r.loggedIn?(ve(),Ai(c,{key:1,db:r.db,user:this.auth.currentUser},null,8,["db","user"])):jt("",!0),r.loggedIn?(ve(),Ai(l,{key:2,db:r.db},null,8,["db"])):jt("",!0)])])}const LS=es(xS,[["render",MS]]);Iw(LS).mount("#app");
